...
# ╔═╡ 02841180-d172-11ed-0956-2d614a2d9be9
using Images


# ╔═╡ 1d39a744-e2ea-4df0-94c6-c4fd9ef95a29
using Flux

# ╔═╡ 13899c74-f395-45de-8af4-f454be20bddf
img1 = load("C:\\Users\\srang\\.julia\\pluto_notebooks\\retinopathy\\training\\0\\0a4e1a29ffff.png")

# ╔═╡ b1c5ca21-8b41-447a-854d-68653b09f256
typeof(img1)

# ╔═╡ 91804f59-b767-445a-8b4f-a9c716c3460c
Gray.(img1)

# ╔═╡ 68191933-d40a-4f9d-b2ce-b89de4c33acf
size(img1)

# ╔═╡ c024b659-927c-41d7-8982-36f8cf47b0a9
function createDataset(path)
    ...
    for label in readdir(path)
        for file in readdir("$path/$label")
            ...
            data = reshape(Float32.(channelview(img)),224,224,3,:)
            if length(X) == 0
                X = data
            else
                X = cat(X,data,dims=4)
...
# ╔═╡ 14bfc74e-80ae-4452-80fa-4e6dcf359950
x_train, y_train = createDataset("C:\\Users\\srang\\.julia\\pluto_notebooks\\retinopathy\\training")

# ╔═╡ 040b0113-577e-4855-94ac-8f494ff6ba93
y_train[3344]

# ╔═╡ d09863e1-e761-480e-9690-17c62bc71eb8
x_test, y_test = createDataset("C:\\Users\\srang\\.julia\\pluto_notebooks\\retinopathy\\testing")

# ╔═╡ f15cea87-bc0c-4a51-9ad3-3e15e11f4b17
model = Chain(
    Conv((5,5),3 => 18, relu),
    MaxPool((2,2)),
    Conv((5,5),18 => 48, relu),
    MaxPool((2,2)),
    Flux.flatten,
    Dense(150528=>70560,relu),
    Dense(70560=>49392, relu),
	Dense(49392=>2940, sigmoid),
    Dense(2940=>5, sigmoid),
    softmax
)
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "c67d25bdf3f6875b864a1f56e281d89f25f29e20"
